...
//    }
    ...
    public Long requestImageAnalysis(String accessToken, String imageUrl, String requestText)  throws IOException{
    ...
    public void requestTakeImageAnalysis(String accessToken, String imageUrl, String requestText, Long todoId)  throws IOException{
